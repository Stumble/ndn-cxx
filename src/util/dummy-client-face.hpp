...
public:
   ...
   */
  explicit
  DummyClientFace(security::v2::KeyChain& keyChain, const Options& options = Options());
   ...
   */
  DummyClientFace(boost::asio::io_service& ioService, security::v2::KeyChain& keyChain,
...
private:
  std::unique_ptr<security::v2::KeyChain> m_internalKeyChain;
